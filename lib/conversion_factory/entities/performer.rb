...
module ConversionFactory
  module Entities
    class Performer
      attr_accessor :converter, :output_extension
      attr_reader   :output_path

      def initialize(converter: nil, output_path: nil, output_extension: nil)
        @converter = converter
      ...
      def run(input_file)
        ...
        converter.convert(input: input_file.file, content_type: input_file.content_type,
                          ...
                          output_extension: defined_output_extension)
      end
      ...
      def define_output_extension(input_file)
        defined_output_extension = input_file.output_extension || output_extension || converter.output_extension
